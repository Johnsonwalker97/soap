  ...
  <div class="card ">
      <div class="card-header">
            <marquee behavior="scroll" width="100%" scrollamount="8" scrolldelay="25">
              <h2 color="success">Vous etes entrain d'enregistrer un nouveau produit dans votre stock !!</h2>
            </marquee>
      </div>
      <div class="card-body">
              ...
              <div class="card">
                ...
                @if ($errors->any())
                 ...
                 <p class="card-text">
                  <div class="row">
                    <div class="col">
                      <input type="integer" class="form-control" id="product_code" name="product_code" placeholder="Code du produit" aria-label="Code du produit" >
                    </div>
                    <div class="col">
                      <input type="Text" class="form-control" id="name" name="name"  placeholder="designation du produit" aria-label="designation du produit" >
                    </div>
                    <div class="col">
                      <input type="integer" class="form-control" id="price" name="price"  placeholder="Prix du produit" aria-label="Prix de produit" >
                    </div>
                  </div>  
